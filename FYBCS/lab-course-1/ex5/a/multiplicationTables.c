...
#include<stdio.h>
int main(){
    int displayTableFrom, displayTableTo, multiple;
    printf("Enter the fromNumber, toNumber and multiple: \n");
    scanf("%d%d%d", &displayTableFrom, &displayTableTo, &multiple);

    
    for(int i = 1; i <= multiple; i++){
        for(int j = displayTableFrom; j <= displayTableTo; j++){
...
/*
Output:
Enter the fromNumber, toNumber and multiple: 
2
9
10
